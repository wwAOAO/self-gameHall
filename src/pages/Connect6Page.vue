    ...
    >
        ...
        >
            ...
            <div class="flex-1 flex items-center justify-center min-h-0 w-full">
                <div
                    class="relative bg-gray-800/60 rounded-lg border border-gray-700/50 p-1.5 shadow-lg shadow-black/20 max-w-full box-border"
                    :style="{ width: `${game.getWidth() + 12}px` }"
                >
                    <canvas
                        ref="canvasRef"
                        :width="game.getWidth()"
                        :height="game.getHeight()"
                        class="block w-full h-auto rounded cursor-pointer"
            ...
            <div class="shrink-0 h-14 pb-2 pt-1 flex items-start justify-center gap-2">
                <button
                    v-if="game.gameStatus.value !== 'idle'"
