...
import { ArrowLeft, CircleDot, Play, RotateCcw } from 'lucide-vue-next';
import { useReversi } from '@/composables/useReversi';
...
<template>
    <div class="min-h-screen select-none overflow-hidden bg-[#14171d] text-white" style="height: 100dvh">
        <div
            class="flex h-full flex-col bg-[linear-gradient(180deg,rgba(255,255,255,0.07)_0,rgba(255,255,255,0)_34%),linear-gradient(135deg,rgba(245,158,11,0.13)_0,rgba(245,158,11,0)_38%,rgba(34,197,94,0.10)_100%)]"
        >
            <header class="mx-auto w-full max-w-6xl shrink-0 px-3 pb-2 pt-3">
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="mr-10 flex-1 text-center text-lg font-bold tracking-normal sm:text-xl">
                        <span class="text-amber-100">黑白棋</span>
                        <span class="ml-2 text-base text-slate-500">Reversi</span>
                    </h1>
                </div>
            </header>
            ...
            >
                <section class="flex min-h-0 flex-1 items-center justify-center">
                    ...
                    >
                        <canvas
                            ...
                            class="aspect-square w-[min(88vw,calc(100dvh-148px),540px)] rounded-md cursor-pointer"
                        ...
                        >
                            <div class="flex w-[min(88%,360px)] flex-col items-center gap-4 text-center">
                                <div>
                                    <p class="text-xl font-black text-amber-100">翻转棋盘，占住四角</p>
                        ...
                        >
                            <div
                                class="w-[min(88%,360px)] rounded-lg border border-white/10 bg-slate-950/82 p-5 text-center shadow-xl"
                            >
                                ...
                                <div class="mt-4 grid grid-cols-2 gap-2 text-sm">
                                    ...
                                    <div class="score-box">
                                        <span>白棋</span>
                                        <strong>{{ game.score.value.white }}</strong>
                                    </div>
                                </div>
                ...
                <aside class="side-panel">
                    <div class="status-line">
                        <div class="turn-disc" :class="game.currentPlayer.value === 1 ? 'black' : 'white'" />
                    ...
                    <div class="stat-grid">
                        ...
                        <div class="stat-card">
                            <span>空位</span>
                            <strong>{{ game.score.value.empty }}</strong>
                        </div>
                        <div class="stat-card">
                            <span>可落子</span>
                            <strong>{{ game.validMoves.value.length }}</strong>
                        </div>
                    </div>
                    ...
                    <div class="rule-notes">
                        <p>黄点表示当前可落子位置，落子必须夹住并翻转至少一枚对方棋子。</p>
                        <p>无棋可下会自动跳过；双方都无棋可下时，棋子更多的一方获胜。</p>
                    </div>
                </aside>
            </main>
        </div>
